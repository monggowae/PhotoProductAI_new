...
export function AnimalPhoto() {
  ...
  const guideSteps = [
    {
      text: "Upload your animal photo or enter a valid image URL. Ensure the animal is clearly visible.",
      image: "https://images.unsplash.com/photo-1450778869180-41d0601e046e?q=80&w=2086&auto=format&fit=crop",
    },
    {
      text: "Select the desired angle for your animal photo. Consider the animal's best features.",
      image: "https://images.unsplash.com/photo-1514888286974-6c03e2ca1dba?q=80&w=2043&auto=format&fit=crop",
    },
    {
      text: "Choose the output ratio that best fits your needs.",
      videoUrl: "https://www.youtube.com/watch?v=OgDJjCBuPRU"
    },
    {
      text: "Select the animal type to ensure the best possible results.",
    },
    {
      text: "Click 'Generate' and wait for your professional animal photo to be created.",
    }
  ];
  ...
  const fetchServiceFee = async () => {
    try {
      const { data, error } = await supabase
        .from('settings')
        .select('int_value')
        .eq('key', 'service_fees_animal_photography')
        .single();
  ...
  const generateImage = async () => {
    ...
    try {
      const response = await fetch('https://n8n-production-7ce8.up.railway.app/webhook/foto_animal', {
        method: 'POST',
        headers: {
  ...
  const handleShare = async () => {
    ...
    try {
      await navigator.share({
        title: 'Generated Animal Photo',
        text: 'Check out this AI-generated animal photo!',
        url: result
      });
    } catch (err) {
  ...
  return (
    <div className="max-w-7xl mx-auto">
      <GuideSection 
        title="How to Generate Animal Photos"
        steps={guideSteps}
      />

      <div className="flex items-center gap-3 mb-8">
        <Camera className="w-8 h-8 text-purple-600" />
        <h1 className="text-3xl font-bold text-gray-900">Animal Photography Generator</h1>
      </div>
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              >
                ...
                <option value="horse">Kuda</option>
