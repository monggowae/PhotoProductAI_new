/*
  ...
  1. Changes
    - Set token price to 300 in default_prices table
    - Update notification templates to use new price
    - Ensure proper price formatting in notifications

  2. Details
    - Updates amount column in default_prices
    - Updates message templates with new price
    - Maintains proper notification handling
*/
